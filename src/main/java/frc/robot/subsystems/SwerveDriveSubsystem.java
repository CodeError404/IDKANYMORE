    ...
    public SwerveDriveSubsystem() {
        ...
        if (Robot.PRACTICE_BOT) {
            mSwerveModules = new SwerveDriveModule[] {
                    new SwerveDriveModule(0, new TalonSRX(6), new TalonSRX(7), 255.5859),
                    new SwerveDriveModule(1, new TalonSRX(5), new TalonSRX(3), 338.906),
                    new SwerveDriveModule(2, new TalonSRX(2), new TalonSRX(3), 13.359),
                    new SwerveDriveModule(3, new TalonSRX(1), new TalonSRX(0), 15.82),
            };
